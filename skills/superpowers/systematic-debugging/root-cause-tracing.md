...
flowchart TD
    ...
    A -->|no| C["Fix at symptom point"]
    B -->|yes| D["Trace to original trigger"]
    B -->|no - dead end| C
    D --> E["Add defense-in-depth layers"]
```
...
Use the bisection script to find the polluter:
