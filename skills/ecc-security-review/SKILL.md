...
description: Security audit checklist and patterns. Use when adding authentication, handling user input, working with secrets, creating API endpoints, or implementing payment/sensitive features. Covers OWASP Top 10, injection prevention, secrets detection, XSS, CSRF, and rate limiting.
---
