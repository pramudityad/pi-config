/**
 * Unicode Preview Module - Renders flowcharts as Unicode/ANSI diagrams
 *
 * Extracted from markdown-graph.ts to provide a lightweight preview
 * for the mermaid-graph extension.
 */
